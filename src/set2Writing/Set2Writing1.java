...
public class Set2Writing1 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Set2Writing1 window = new Set2Writing1();
	...
	{
		try {
			String query= "SELECT writing FROM test2question WHERE rowid=?;";
	...
	private void initialize() {
		...
		textPane_1.setFont(new Font("Serif", Font.PLAIN, 16));
		textPane_1.setEditable(false);
		textPane_1.setBackground(Color.WHITE);
		textPane_1.setText(getText());
		textPane_1.setBounds(94, 164, 1168, 260);
		...
		JLabel lblItemNo = new JLabel("Item no 1 of 3");
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				 ...
				 frame.dispose();
				 Set2Writing2 go=new Set2Writing2();
				 go.frame.setVisible(true);
			}
		});
		...
		panel_3.setBounds(92, 435, 1172, 146);
