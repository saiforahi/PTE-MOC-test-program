...
public class Set2Reorder2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Set2Reorder2 window = new Set2Reorder2();
	...
	private void initialize() {
		...
		question[0]="<html><p align='CENTER'>How is it that fertilized chicken eggs manage to resist fracture from the outside, while at the same time, are weak enough to break from the inside during chick hatching? It's all in the eggshell's nanostructure.</p></html>";
		question[1]="<html><p align='CENTER'>The shell, being not too strong, but also not too weak (being \"just right\" Goldilocks might say), is resistant to fracture until it's time for hatching. </p></html>";
		question[2]="<html><p align='CENTER'>But what exactly gives bird eggshells these unique features? To find out researchers used new sample-preparation techniques to expose the interior of the eggshells to study their molecular nanostructure and mechanical properties.</p></html>";
		question[3]="<html><p align='CENTER'>Eggshells are notoriously difficult to study by traditional means, because they easily break when we try to make a thin slice for imaging by electron microscopy.</p></html>";
		question[4]="<html><p align='CENTER'>The results provide insight into the biology and development of chicken embryos in fertilized and incubated eggs, and could have important implications for food safety.</p></html>";
		frame = new JFrame();
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				frame.dispose();
				Set2FillBlank1 go=new Set2FillBlank1();
				go.frame.setVisible(true);
			}
		});
		button.setFont(new Font("Tahoma", Font.BOLD, 12));
		button.setBounds(1176, 639, 89, 28);
		...
		panel.setBorder(new MatteBorder(2, 0, 2, 0, (Color) new Color(51, 102, 102)));
		panel.setBounds(697, 112, 492, 509);
		...
		panel_1.setBorder(new MatteBorder(2, 0, 2, 0, (Color) new Color(51, 102, 102)));
		panel_1.setBounds(181, 112, 492, 509);
		frame.getContentPane().add(panel_1);
		
		q1 = new JLabel("<html><p align='CENTER'>How is it that fertilized chicken eggs manage to resist fracture from the outside, while at the same time, are weak enough to break from the inside during chick hatching? It's all in the eggshell's nanostructure.</p></html>");
		...
		q2 = new JLabel("<html><p align='CENTER'>The shell, being not too strong, but also not too weak (being \"just right\" Goldilocks might say), is resistant to fracture until it's time for hatching. </p></html>");
		...
		q3 = new JLabel("<html><p align='CENTER'>But what exactly gives bird eggshells these unique features? To find out researchers used new sample-preparation techniques to expose the interior of the eggshells to study their molecular nanostructure and mechanical properties.</p></html>");
		...
		q4 = new JLabel("<html><p align='CENTER'>Eggshells are notoriously difficult to study by traditional means, because they easily break when we try to make a thin slice for imaging by electron microscopy.</p></html>");
		...
		q5 = new JLabel("<html><p align='CENTER'>The results provide insight into the biology and development of chicken embryos in fertilized and incubated eggs, and could have important implications for food safety.</p></html>");
		...
		JLabel lblReadingTest = new JLabel("Reading Test");
		lblReadingTest.setFont(new Font("Tahoma", Font.BOLD, 24));
		lblReadingTest.setBounds(10, 0, 497, 56);
		panel_3.add(lblReadingTest);
